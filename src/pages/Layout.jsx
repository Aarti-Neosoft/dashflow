...
function Layout() {
  ...
  return (
    <div
      className={`flex min-h-screen flex-col lg:flex-row ${isDark ? "bg-[#020617] text-white" : "bg-slate-100 text-slate-900"
        }`}
    >
      <div
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-4 relative">
            ...
            <button
              ...
              className={`flex items-center gap-2 rounded-lg px-3 py-2 border ${isDark
            ...
            {menuOpen && (
              <div
                className={`absolute right-0 top-full mt-2 w-56 rounded-2xl border shadow-xl text-left ${isDark
                  ? "bg-[#0b1220] border-white/10"
                  : "bg-white border-slate-200"
                  }`}
              >
                <div
                  className={`px-4 py-4 ${isDark ? "text-white" : "text-slate-900"
                    }`}
                >
                ...
                <button
                  ...
                  className={`w-full text-left px-4 py-3 ${isDark
